...
import math
# NOTE: IF PIL NEEDS TO BE INSTALLED, INSTALL "pillow" INSTEAD. THE PACKAGE IS CALLED "PIL" WHEN YOU IMPORT IT BUT
# WHEN YOU INSTALL IT IT IS CALLED "pillow"
...
for i in range(frame_count):
    image_names.append("AI" + str(i + 1) + ".png") # ["AI1.png", "AI2.png", ... ]
    output_files.append("AI" + str(i + 1) + ".txt") # ["AI1.txt", "AI2.txt", ... ]
